	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'nirmalnaikca@gmail.com',
			link: 'mailto:nirmalnaikca@gmail.com'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Phone',
			value: '(249)-688-1511',
			link: 'tel:+12496881511'
		},
		{
	...
	const socialLinks = [
		{
			...
			label: 'GitHub',
			link: 'https://github.com/nirmalnaik'
		},
		{
			icon: <Linkedin className="w-5 h-5" />,
			label: 'LinkedIn',
			link: 'https://www.linkedin.com/in/nirmal-naik/'
		},
		{
					...
					>
						...
						<form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
							...
							{submitStatus === 'error' && (
								...
								>
									Failed to send message. Please try again or contact me directly at nirmalnaikca@gmail.com
								</motion.p>
							)}
						</form>
					</motion.div>
